...
#if XPAR_CPU_ID == 0
#define KR260DEMO_RPU_CORE_ID 0u
#define KR260DEMO_RPU_SERVICE_NAME "mncos-r5c0-ctrl"
#define KR260DEMO_RPU_UF2_LED_BASEADDR 0xb0000000UL
#define KR260DEMO_RPU_LED_MASK 0x01u
#define KR260DEMO_RPU_HEARTBEAT_PERIOD_MS 1000u
#ifndef SHARED_MEM_PA
#define SHARED_MEM_PA 0x09860000UL
#endif
#elif XPAR_CPU_ID == 1
#define KR260DEMO_RPU_CORE_ID 1u
#define KR260DEMO_RPU_SERVICE_NAME "mncos-r5c1-ctrl"
#ifndef SHARED_MEM_PA
